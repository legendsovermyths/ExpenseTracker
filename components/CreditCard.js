...
const CreditCard = ({ bankName, amount }) => {
  return (
   <View style={styles.container}>        
      ...
      <View style={{marginTop:62, marginLeft:35}}>
        
      <Text style={{color:COLORS.white,...FONTS.h2}}>
          {bankName}
      </Text>
      <Text style={{marginTop:23.5, marginLeft:5, color:COLORS.white,...FONTS.credBold}}>Credit</Text>
<Text style={{marginTop:30,color:COLORS.white, ...FONTS.cred}}>{"Amount: ₹"+formatAmountWithCommas(amount)}</Text>

<Text style={{color:COLORS.white, ...FONTS.cred}}>{"Date: 24th Nov"}</Text>
      </View> 
</View>
